            ...
            <div class="col-md-6 offset-md-3"  style="background: white; padding: 20px; box-shadow: 10px 10px 5px #888888; margin-top: 100px;">
                <hr>
                    <div style="text-align: center;">
                           ...
                           <p>Please click on the below link for Remedy of DDoS Attack In Computer Networks</p>
                    </div>
                <hr>    
                    <a target="_blank" href="http://localhost/AntiDDos2/"><p style="text-align: center;;">Script to perform DDoS Attack</p></a>
            </div>
        </div>
    </div>
</body>
